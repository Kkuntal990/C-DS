...
\textbf{Explanation}
\newline
\textsl{tob} function stores positive decimal integer to its unsigned binary format given
the input array pointer points to sufficiently large length array or it will throw an error.
